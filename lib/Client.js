...
Client.prototype.find = function(callback) {
	if(this._seaport) {
		...
		this.once("seaportUp", this._executeCallback.bind(this, callback));
	}
};
...
Client.prototype.register = function(options) {
	this.on("seaportUp", this._executeCallback.bind(this, this._createService.bind(this, options)));
};
...
Client.prototype._executeCallback = function(callback) {
	callback(this._seaport);
};
